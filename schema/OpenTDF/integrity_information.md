...
| segments                    | Array  | An array of [Segment Objects](#encryptioninformationintegrityinformationsegment), one for each chunk of the payload if method.isStreamable is true. Order MUST match payload order.                 | Yes       |
